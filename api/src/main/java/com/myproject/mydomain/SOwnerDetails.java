...
public class SOwnerDetails extends com.querydsl.sql.RelationalPathBase<SOwnerDetails> {
    ...
    private static final long serialVersionUID = -2064845326;
    ...
    public final com.querydsl.sql.ForeignKey<SBlogDetails> _fklyfudlsb9wjcxpyhe7am95d4v = createInvForeignKey(id, "OWNER_ID");
