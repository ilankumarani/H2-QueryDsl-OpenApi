package com.querydsl.sql.owner_schema;
...
public class SOwnerDetails extends com.querydsl.sql.RelationalPathBase<SOwnerDetails> {
    ...
    private static final long serialVersionUID = 2140077645;
    ...
    public final com.querydsl.sql.ForeignKey<com.querydsl.sql.blog_schema.SBlogDetails> _fklyfudlsb9wjcxpyhe7am95d4v = createInvForeignKey(id, "OWNER_ID");
