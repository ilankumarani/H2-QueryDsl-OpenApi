...
public class SInformationSchemaCatalogName extends RelationalPathBase<SInformationSchemaCatalogName> {

    private static final long serialVersionUID = -1136423234;
