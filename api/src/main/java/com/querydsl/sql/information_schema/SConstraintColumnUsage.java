...
public class SConstraintColumnUsage extends com.querydsl.sql.RelationalPathBase<SConstraintColumnUsage> {

    private static final long serialVersionUID = 1275299593;
