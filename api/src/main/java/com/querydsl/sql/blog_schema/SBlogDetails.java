package com.querydsl.sql.blog_schema;
...
public class SBlogDetails extends com.querydsl.sql.RelationalPathBase<SBlogDetails> {
    ...
    private static final long serialVersionUID = 1659965897;
    ...
    public final com.querydsl.sql.ForeignKey<com.querydsl.sql.owner_schema.SOwnerDetails> fklyfudlsb9wjcxpyhe7am95d4v = createForeignKey(ownerId, "ID");
