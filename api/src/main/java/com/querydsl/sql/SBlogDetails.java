...
public class SBlogDetails extends RelationalPathBase<SBlogDetails> {

    private static final long serialVersionUID = -54761287;
    ...
    public final PrimaryKey<SBlogDetails> constraintC = createPrimaryKey(id);

    public final ForeignKey<SOwnerDetails> fklyfudlsb9wjcxpyhe7am95d4v = createForeignKey(ownerId, "ID");
